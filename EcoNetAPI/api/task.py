...
class Task(object):
    ...
    def on_get(self, req, resp):
        logging.info('Getting the task')
		#Modify the code : we want to have a query that 
		# 1 answer ALL the tasks (param : all)
		# 2 answer only one task (param : taskName)
		#Ask mehdi how to retrieve info from the database
        resource = {
            #'id': 1,
            #'name': 'Random Name'
        }
